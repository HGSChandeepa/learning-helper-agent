...
code_executor_v2_runner = Agent(
    ...
    instruction='''Execute the matplotlib animation code provided by seq_agent_1 and handle the output.
        ...
        File Management:
        - Save as "animation_v2.gif" to distinguish from V1
        - Ensure proper cleanup of temporary files
        - Handle concurrent execution with V1
    ...
    output_key="animation_execution_result_v2",
)